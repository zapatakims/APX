...
/****** Object:  StoredProcedure [APXUserCustom].[pGetReportingClassification]    Script Date: 06/12/2015 14:48:16 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[APXUserCustom].[pGetReportingClassification]') AND type in (N'P', N'PC'))
